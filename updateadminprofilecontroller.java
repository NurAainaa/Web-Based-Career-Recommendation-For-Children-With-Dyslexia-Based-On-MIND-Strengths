...
/**
 * Servlet implementation class updateadminprofilecontroller
 */
@WebServlet("/updateadminprofilecontroller")
public class updateadminprofilecontroller extends HttpServlet {
     ...
     */
    public updateadminprofilecontroller() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		adminacc pt = new adminacc();
		pt.setId(Integer.parseInt(request.getParameter("myid")));
		pt.setEmail(request.getParameter("signupmail"));
		
		
		dao.updateAdminProfile(pt);
		
		response.sendRedirect("AdminhomeAfterUpdateProfile.jsp");
	}
